...
// nothing to do for now; the unique ptr should handle destroying the array
// itself
ShaderManager::~ShaderManager() {}

bool ShaderManager::loadShaderFile(int id, std::string path,
...
sf::Shader& ShaderManager::getShader(int id) { return m_shaderContainer[id]; }
